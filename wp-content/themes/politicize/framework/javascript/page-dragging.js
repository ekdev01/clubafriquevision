...
jQuery(document).ready(function () {
    ...
    var DIV_SIZE = [
        ['1/4', 'element1-4', 1 / 4, ['Services','Column','Sidebar','Gallery', 'Contact-Form', 'Content', 'Slider', 'Accordion', 'Tab', 'Message-Box', 'Toggle-Box','Venue']],
        ['1/3', 'element1-3', 1 / 3, ['Portfolio','Services','Sidebar','Column', 'Gallery', 'Contact-Form', 'Content','Slider', 'Accordion', 'Tab', 'Message-Box', 'Toggle-Box','Venue']],
        ['1/2', 'element1-2', 1 / 2, ['Events','News','Services','Timeline','Sidebar','Contact-Form', 'Column', 'Gallery',  'Single-Album','Content','Slider', 'Accordion', 'Tab', 'Message-Box', 'Toggle-Box','Venue']],
        ['2/3', 'element2-3', 2 / 3, ['Crowd-Funding','Next-Events','Sidebar','Event-Calendar','Events','Music-Gallery','Services','Column', 'Gallery', 'Contact-Form', 'Content', 'Slider', 'Accordion', 'Tab', 'Message-Box', 'Toggle-Box','Venue']],
        ['3/4', 'element3-4', 3 / 4, ['Services','Column', 'Gallery','Sidebar','Contact-Form', 'Content','Modern-Blog','Slider', 'Accordion', 'Tab', 'Message-Box', 'Toggle-Box','Venue']],
        ['1/1', 'element1-1', 1, ['Portfolio','Blog-Slider','Latest-News','Crowd-Funding','Crowd-Slider','Timeline','Feature-Projects','Woo-Products','Next-Events','Sidebar','Artists','Services', 'Column', 'Gallery', 'Content', 'Blog','Events','Music-Gallery', 'News', 'Albums', 'Slider', 'Accordion', 'Tab', 'Divider', 'Message-Box', 'Toggle-Box', 'Contact-Form','Carousel']],
    ];
    ...
    jQuery("div.combobox #page-option-item-event-view").change(function () {
		...
		}else if(jQuery(this).val() == 'Government View'){
			jQuery('.event-type-item').parent().removeClass('default-slider-hide');
		}
		else{
			jQuery('.event-type-item').parent().addClass('default-slider-hide');
